...
def index():
    ...
    if request.method == "POST":
        ...
        # Predict
        pred = predict(model, scaler, df_processed)[0]
        return render_template("result.html", result={"prediction": pred})
...
def retrain():
    ...
    if request.method == "POST":
        ...
        comparison = {
            ...
            "new_model": {"accuracy": new_acc, "confusion_matrix": new_cm, "hyperparameters": {"n_neighbors": n_neighbors, "metric": metric, "weights": weights}},
            "better_model": chosen
        }
